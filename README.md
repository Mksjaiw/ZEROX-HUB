...
function RadientPaid:Window(text,maincolor)
   ...
   CloseBtn.Text = "Drestroy     "
   CloseBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
   CloseBtn.TextSize = 10.000
   ...
   UserTag.TextColor3 = Color3.fromRGB(215, 25, 42)
   UserTag.TextSize = 15.000
   UserTag.TextTransparency = 0
   UserTag.TextXAlignment = Enum.TextXAlignment.Left

   UserName.Text = "ZEROX HUB"
   UserTag.Text = "#" .. "By ZeroX Official  "
   ...
   UserPanelUserCircle.Image = "rbxassetid://38157161"
   ...
   UserPanelUserIcon.MouseButton1Click:Connect(function()
      ...
      ResetBtn.MouseButton1Click:Connect(function()
         pfp = "https://www.roblox.com/headshot-thumbnail/image?userId=38157161".. game.Players.LocalPlayer.UserId .."&width=420&height=420&format=png"
         UserImage.Image = pfp
         UserPanelUserImage.Image = pfp
         SaveInfo()
   ...
   function ServerHold:Server(text,textgame, img)
      ...
      function ChannelHold:Channel(text)
         ...
         function ChannelContent:Toggle(text,default,callback)
            ...
            Icon.Image = "https://www.roblox.com/asset/?id=9105809119"
   ...
   return ServerHold
	...
	Main:Toggle("Start",false,function(vu)
	    print(vu)
	end)
    ...
    Main:Slider("Distance",0,10,5,function(a)
        print(a)
    end)
	local Main = serv:Channel("Esp")
    Main:Label("ESP")
	Main:Toggle("ESP PLayer",false,function(vu)
	    print(vu)
    end)
    Main:Toggle("ESP Chest",false,function(vu)
	    print(vu)
    end)
    Main:Toggle("ESP Fruit",false,function(vu)
	    print(vu)
    end)
    local Main = serv:Channel("Devil Fruits")
	Main:Label("Fruits")
    Main:Dropdown("Select Fruit", {"Bomb","Spike","Chop","Spring","Kilo","Smoke","Spin","Flame","Falcon","Ice","Sand","Dark","Revive","Diamond","Light","LoveRubber","Barrier","Magma","Door","Quake","Buddha","String","Phoenix","Rumble","Paw","Gravity","Dough","Shadow","Venom","Control","Soul","Dragon"}, function(powerx)
        print(zerox)
    end)
    Main:Toggle("Sniper fruit",false,function(vu)
	    print(vu)
    end)
    Main:Toggle("Random Fruits",false,function(vu)
	    print(vu)
    end)
    Main:Toggle("Auto Keep Fruits",false,function(vu)
	    print(vu)
    end)
